            ...
            <div className="container mx-auto flex-align-center nmt-8">
            	<div className="flex-align-center w-full flex-row">
                    ...
                    <div className="col-9 pr-3">
                        <div className="lrg-text-size bold mb-1">Professional Profile</div>
                        ...
                        <div className="line-seperator mb-1 bg-white faded"></div>
                        <p className="intro lh-normal">Email me at <a className="paragraph-link bg-round" href="mailto:bobbypatterson404@gmail.com">bobbypatterson404@gmail.com<LinkArrow /></a></p>
                        <p className="intro lh-normal">Message me on <a target="_blank" rel="noopener noreferrer" className="paragraph-link bg-round" href="https://www.linkedin.com/in/hello-bobby/">LinkedIn<LinkArrow /></a></p>
                    </div>
                </div>
            </div>
        );
